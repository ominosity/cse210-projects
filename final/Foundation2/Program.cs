...
class Program
{
    static void Main(string[] args)
    {
        ...
        Product product6 = new Product("Silicone Straw Covers and Caps - Cats - for Stanly Tumblers", 98735, 6.29, 1);
        Product product7 = new Product("Insefocc Stanly Cup 40oz Snack Bowl with Handle", 359846, 6.29, 1);
